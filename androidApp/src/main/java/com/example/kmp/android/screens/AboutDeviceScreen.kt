...
@Composable
fun AboutDeviceScreen(onUpButtonClicked: () -> Unit){
    Column {
...
fun makeItems(): List<Pair<String, String>> {
    ...
    return listOf(Pair("Operating System", "${platform.osName} ${platform.osVersion}"), Pair("Device", "${platform.deviceModel} " ),Pair("Density", "${platform.density} " ))
}
